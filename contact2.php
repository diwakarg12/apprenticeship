...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <!-- <h1 class="m-0 text-dark">Image Change</h1> -->
          </div>
          <h1>Submit Contact2 to Database</h1>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql1 = "UPDATE aprenticeship_db3 SET first1 = '$text1' WHERE id = 1"; // Assuming you have a unique identifier for the row, here I use 'id' as an example
    $sql2 = "UPDATE aprenticeship_db3 SET second1 = '$text2' WHERE id = 1"; // Assuming you have a unique identifier for the row, here I use 'id' as an example
    $sql3 = "UPDATE aprenticeship_db3 SET third1 = '$text3' WHERE id = 1"; // Assuming you have a unique identifier for the row, here I use 'id' as an example
